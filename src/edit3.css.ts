...
export const content = style({flex: "1 1 auto", marginLeft: "2px", marginRight: "3.5px"});
...
export const top_left_cell = style({gridRow: 1, position: "relative", border: grid_border});
export const bottom_left_cell = style({gridRow: 2, position: "relative", border: grid_border});
export const top_right_cell = style({gridRow: 1, position: "relative", overflow: "scroll", border: grid_border});
export const bottom_right_cell = style({gridRow: 2, position: "relative", border: grid_border});

export const edge = style({position: "absolute", zIndex: 2, backgroundClip: "padding-box"});
export const horizontal_edge = style([edge, {width: "100%", height: "8px", cursor: "row-resize"}]);
export const vertical_edge = style([edge, {height: "100%", width: "8px", cursor: "col-resize"}]);
...
export const editor = style({ height: "100%", position: "absolute", top: 0, bottom: 0, left: 0, right: 0 });
