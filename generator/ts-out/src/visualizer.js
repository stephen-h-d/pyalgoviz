...
export class Visualizer {
    ...
    progressDiv;
    animator = null;
    constructor(algoEditor, outputArea, vizEditor, vizOutputArea, runButton, playPauseButton, speedSelect, renderAreaDiv, progressDiv) {
    ...
    async doRun() {
        ...
        try {
            ...
            if (events !== undefined) {
                ...
                this.animator = new Animator(this.vizOutputArea, this.playPauseButton, this.speedSelect, this.progressDiv, this.renderAreaDiv, events, this.algoEditor.setHighlightLine.bind(this.algoEditor), this.vizEditor.setErrorLine.bind(this.vizEditor));
            }
            else {
            ...
            console.log(`Error in pyodideWorker: ${e}`);
        }
